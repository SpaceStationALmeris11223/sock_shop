...
home() functions sets up the home page, so it gets the products and the categories
then adds them to the index.hteml file that servres as the template for the homepage"""
@app.route('/')
def home():
...
add_to_cart finctions sets up the add to cart page"""
...
the cart() finctions sets up the cart page, and gets the cart with the items
